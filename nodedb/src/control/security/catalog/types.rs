...
pub(super) use super::tables::{
    ...
    COLLECTIONS, COLLECTIONS_LEGACY, COLUMN_STATS, CONSUMER_GROUPS, CUSTOM_TYPES, DATABASE_HWM,
    DATABASES, DATABASES_BY_NAME, DEPENDENCIES, FUNCTIONS, L2_CLEANUP_QUEUE, LOCKOUT_STATE,
    ...
    SYNONYM_GROUPS, TENANTS, TOPICS_EP, TRIGGERS, USERS, VECTOR_MODEL_METADATA, WAL_TOMBSTONES,
    WASM_MODULES,
};
