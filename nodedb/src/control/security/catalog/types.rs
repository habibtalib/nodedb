...
pub(super) use super::tables::{
    ...
    CLONE_COPYUPS, CLONE_LINEAGE, CLONE_TOMBSTONES, COLLECTIONS, COLLECTIONS_LEGACY, COLUMN_STATS,
    CONSUMER_GROUPS, CUSTOM_TYPES, DATABASE_GRANTS, DATABASE_HWM, DATABASE_QUOTAS, DATABASES,
    DATABASES_BY_NAME, DEPENDENCIES, FUNCTIONS, L2_CLEANUP_QUEUE, LOCKOUT_STATE,
    MATERIALIZED_VIEWS, METADATA, ORG_MEMBERS, ORGS, OWNERS, PERMISSIONS, PROCEDURES,
    RETENTION_POLICIES, ROLES, SCHEDULES, SCOPE_GRANTS, SCOPES, SEQUENCE_STATE, SEQUENCES,
    STREAMING_MVS, SURROGATE_PK, SURROGATE_PK_LEGACY, SURROGATE_PK_REV, SURROGATE_PK_REV_LEGACY,
    SYNONYM_GROUPS, TENANT_QUOTAS, TENANTS, TOPICS_EP, TRIGGERS, USERS, VECTOR_MODEL_METADATA,
    WAL_TOMBSTONES, WASM_MODULES,
};
