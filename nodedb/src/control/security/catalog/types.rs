...
pub(super) use super::tables::{
    ...
    DATABASE_HWM, DATABASES, DATABASES_BY_NAME, DEPENDENCIES, FUNCTIONS, L2_CLEANUP_QUEUE,
    LOCKOUT_STATE, MATERIALIZED_VIEWS, METADATA, ORG_MEMBERS, ORGS, OWNERS, PERMISSIONS,
    ...
    SURROGATE_PK_REV_LEGACY, SYNONYM_GROUPS, TENANTS, TOPICS_EP, TRIGGERS, USERS,
